# RailsAdmin config file. Generated on December 01, 2011 20:26
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Timenote', 'Admin']
  ...
  # config.excluded_models = [Image, Item, User]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Image, Item, User]
  ...
  #   # Found associations:
  #     field :images, :has_many_association 
  #     field :user, :belongs_to_association   #   # Found columns:
  #     field :id, :integer 
  #     field :title, :string 
  #     field :content, :text 
  ...
  #     field :publish_type, :string   #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  #   edit do; end
  ...
  #   # Found associations:
  #     field :items, :has_many_association   #   # Found columns:
  #     field :id, :integer 
  #     field :email, :string 
  ...
  #     field :created_at, :datetime 
  #     field :updated_at, :datetime 
  #     field :domain_name, :string   #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  #   edit do; end
